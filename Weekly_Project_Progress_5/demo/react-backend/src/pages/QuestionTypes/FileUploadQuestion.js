...
const FileUploadQuestion = (props) => {
	...
	return (
		<QuestionLayout headingText="New Question - File Upload" title="File Upload" assessmentID={assessment} payload={getPayload()} validator={validate} history={props.history} id={id} role={role}>
			<Col md={6}>
				<div className="mb-4">
